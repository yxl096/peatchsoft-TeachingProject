    ...
    class 战斗管理器
    {
        ...
        public void 处理伤害事件(DamageInfo 攻击事件)
        {
            do
            {
                ...
                {
                    攻击效果.发动者.buff池.发动普通攻击效果(攻击效果.发动者, 攻击事件);
                }

                switch (攻击效果.DamageType)
                {
                    case 伤害类型.物理:
                        攻击效果.发动者.buff池.造成物理伤害效果(攻击效果.发动者, 攻击事件);
                        break;
                    case 伤害类型.法术:
                        攻击效果.发动者.buff池.造成法术伤害效果(攻击效果.发动者, 攻击事件);
                        break;
                    case 伤害类型.治疗:
                        攻击效果.发动者.buff池.发动治疗效果(攻击效果.发动者, 攻击事件);
                        break;
                }
                ...
                {
                    case 伤害类型.物理:
                        角色.buff池.受到物理伤害效果(攻击效果.发动者, 攻击事件);
                        角色.受到攻击伤害(攻击效果);
                        break;
                    case 伤害类型.法术:
                        角色.buff池.受到法术伤害效果(攻击效果.发动者, 攻击事件);
                        角色.受到攻击伤害(攻击效果);
                        break;
                    case 伤害类型.治疗:
                        角色.buff池.受到治疗效果(攻击效果.发动者, 攻击事件);
                        角色.获得治疗(攻击效果);
                        break;
                    case 伤害类型.法力恢复:
                        角色.获得法力值恢复(攻击效果);
